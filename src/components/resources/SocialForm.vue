...
<template>
  <div class="space-y-4 py-4 overflow-x-hidden">
    ...
    <div class="space-y-2">
      ...
      <Input v-model="form.Platform" placeholder="e.g. GitHub, Twitter" required class="min-w-0" />
    </div>
    <div class="space-y-2">
      <Label>{{ t('resources.url') }}</Label>
      <Input v-model="form.Url" placeholder="https://" required class="min-w-0 break-all" />
    </div>
