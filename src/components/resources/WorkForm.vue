  ...
  <div class="space-y-4 py-4 overflow-x-hidden">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div class="space-y-2 min-w-0">
        ...
        <Input v-model="form.CompanyName" required class="min-w-0" />
      </div>
      <div class="space-y-2 min-w-0">
        <Label>{{ t('resources.position') }}</Label>
        <Input v-model="form.Position" required class="min-w-0" />
      </div>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div class="space-y-2 min-w-0">
    ...
    <div class="space-y-2">
      ...
      <Textarea v-model="form.Description" class="min-w-0 resize-none" />
    </div>
