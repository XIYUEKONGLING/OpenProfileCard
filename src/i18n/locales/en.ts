export const en = {
    ...
    dashboard: {
        ...
        accountWillBeDeleted: 'Account will be deleted in:',
        countdownDaysPart: '{days}d',
        countdownHoursPart: '{hours}h',
        countdownMinutesPart: '{minutes}m',
        countdownSecondsPart: '{seconds}s',
        countdownDays: '{days} days {hours} hours',
        countdownHours: '{hours} hours {minutes} minutes',
        countdownMinutes: '{minutes} minutes {seconds} seconds',
        contactSupport: 'Contact Support',
        contactSupportSubject: 'Support Request: Account Issue',
        contactSupportBody: 'Hello,\n\nI am writing regarding my account @{account}.\n\nPlease assist me with the following issue:\n\n',
        contactSupportOrgBody: 'Hello,\n\nI am writing regarding the organization "{org}".\n\nPlease assist me with the following issue:\n\n',
    ...
    admin: {
        ...
        accountsByRole: 'Accounts by Role',
        assets: 'Assets',
        totalAccountAssets: 'Total Account Assets',
        totalSystemAssets: 'Total System Assets',
    ...
    assetLibrary: {
        ...
        selected: 'selected',
        batchUpdateVisibility: 'Update Visibility',
        total: 'total',
        createAsset: 'Create Asset',
        createAssetDesc: 'Add a new asset to your library.',
        editAsset: 'Edit Asset',
        editAssetDesc: 'Modify the asset details.',
        assetFile: 'Asset File',
        assetFileDesc: 'Choose an image, icon, or upload a file.',
        category: 'Category',
        categoryPlaceholder: 'e.g., avatars, icons, banners',
        notes: 'Notes',
        notesPlaceholder: 'Optional notes about this asset',
    },
    notifications: {
        title: 'Notifications',
