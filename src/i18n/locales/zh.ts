export const zh = {
    ...
    assetLibrary: {
        ...
        selected: '已选择',
        batchUpdateVisibility: '更新可见性',
        total: '总计',
        createAsset: '创建资源',
        createAssetDesc: '向您的资源库添加新资源。',
        editAsset: '编辑资源',
        editAssetDesc: '修改资源详情。',
        assetFile: '资源文件',
        assetFileDesc: '选择图片、图标或上传文件。',
        category: '分类',
        categoryPlaceholder: '例如：头像、图标、横幅',
        notes: '备注',
        notesPlaceholder: '关于此资源的可选备注',
    },
    notifications: {
        title: '通知中心',
        empty: '暂无通知',
