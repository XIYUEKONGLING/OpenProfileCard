...
<template>
  <!-- CHANGED: min-h-screen -> h-screen to fix sidebar scrolling behavior -->
  <div class="h-screen bg-background flex flex-col md:flex-row overflow-hidden">
    ...
    <!-- Mobile Fullscreen Menu (omitted details for brevity, largely same structure as desktop but absolute) -->
    ...
    <!-- MAIN CONTENT AREA        -->
    <!-- ======================== -->
    <!-- This scrolls independently now -->
